...
std::unique_ptr<Pass> createCIRToCFPass();
std::unique_ptr<Pass> createCIRToCppAtomicPass();
...
std::unique_ptr<Pass> createCIRToPtrPass();
std::unique_ptr<Pass> createCIROrbCleanupPass();
